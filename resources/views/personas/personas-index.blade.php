...
@endsection
@section('content')
<h1 class="mt-2 text-center">Listado de personas</h1>
<a class="btn btn-success mb-3" href="{{route('personas.create')}}">Crear</a>
<div class="table-responsive">
            <table class="table">
                <thead class="bg-dark">
                    <th class="text-white">Nombre</th>
                    <th class="text-white">Apellido paterno</th>
                    <th class="text-white">Apellido paterno</th>
